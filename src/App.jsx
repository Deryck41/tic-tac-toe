...
function App() {
  ...
  const {cells, currentSymbol, winner, Reset, HandleClick, size, SetSize } = useGameState(crossClassName, circleClassName);
  ...
  return (
    <Container>
      <TopBar>
        <TransparentButton right="30px" iconed="true" onClick={()=> SetModalOpen(true)}>
